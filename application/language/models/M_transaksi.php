...
class M_transaksi extends CI_Model{
    ...
    function update_trs_beli(){
        ...
        if ($params->aksi == 'Terima') {
            ...
            $this->insert_stok("tr_pembelian_detail",$params->id_pembelian,"qty","id_pembelian");
        }
    ...
    function get_inv(){
        ...
        $query = $this->db->query("SELECT * FROM trs_invdet WHERE id_toko = '".$params->id_toko."' AND id_produk = '".$params->id_produk."' ")->result();
