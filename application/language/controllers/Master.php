...
class Master extends CI_Controller {
    ...
    public function index()
    {
        ...
        $store_m = $this->input->get('m') == '' ? $this->session->userdata('id_toko') : $this->input->get('m') ;
        $store_d = $this->input->get('d') == '' ? $this->session->userdata('id_toko') : $this->input->get('d') ;
        $store_s = $this->input->get('s') == '' ? $this->session->userdata('id_toko') : $this->input->get('s') ;
