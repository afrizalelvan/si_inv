      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" class="form-control" id="nm_kategori" placeholder="Masukan..">
          </div>
        </div>
...
<script type="text/javascript">
  ...
  function load_data() {
    ...
    tabel = $('#datatable').DataTable({
      ...
      "paging": true,
      "ajax": {
        "url": '<?php echo base_url(); ?>Master/load_data/Kategori',
        "type": "POST",
        // data  : ({tanggal}),
      },
      responsive: true,
  ...
  function simpan(){
     ...
     if (nm_kategori == '' || s_aktif == '' ) {
      ...
      $.ajax({
          ...
          type    : "POST",
          data     : ({id_kategori,nm_kategori,s_aktif,jenis:'m_kategori',status}),
          dataType: "JSON",
  ...
  function tampil_edit(id,act){
    ...
    status = "update";
         ...
         $.ajax({
              ...
              type: 'POST',
              data: {id: id,jenis : "m_kategori",field:'id_kategori'},
              dataType: "JSON",
          })
          .done(function(data) {
