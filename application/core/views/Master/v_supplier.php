    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="hidden" class="form-control" id="id_supplier" >
            <input type="text" class="form-control" id="nm_supplier" placeholder="Masukan..">
          </div>
        </div>
        <div class="form-group row">
...
/* $('.tambah_data').click(function() {
  ...
  function simpan(){
     ...
     if (nm_supplier == '' ||s_aktif == '' || no_telp == '0' || no_telp == '') {
      ...
      $.ajax({
          ...
          type: "POST",
          data     : ({id_supplier,nm_supplier,no_telp,alamat,s_aktif,jenis:'m_supplier',status}),
          dataType: "JSON",
  ...
  function tampil_edit(id,act){
    ...
    status = "update";
         ...
         $.ajax({
              ...
              type: 'POST',
              data: {id: id,jenis : "m_supplier",field:'id_supplier'},
              dataType: "JSON",
          })
          .done(function(data) {
